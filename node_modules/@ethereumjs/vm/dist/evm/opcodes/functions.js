...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            // copy fee
            runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'sha3Word')).imul(util_1.divCeil(length, new ethereumjs_util_1.BN(32))));
    ...
    [
        ...
        function (runState) {
            ...
            runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'copy')).imul(util_1.divCeil(dataLength, new ethereumjs_util_1.BN(32))));
    ...
    [
        ...
        function (runState) {
            ...
            runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'copy')).imul(util_1.divCeil(length, new ethereumjs_util_1.BN(32))));
    ...
    [
        ...
        function (runState) {
            ...
            util_1.subMemUsage(runState, memOffset, length);
            runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'copy')).mul(util_1.divCeil(length, new ethereumjs_util_1.BN(32))));
    ...
    [
        ...
        async function (runState) {
            ...
            if (!value.isZero()) {
                runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'callValueTransfer')));
            }
            let data = Buffer.alloc(0);
            if (!inLength.isZero()) {
            ...
            if (runState._common.gteHardfork('spuriousDragon')) {
                ...
                if ((await runState.eei.isAccountEmpty(toAddress)) && !value.isZero()) {
                    runState.eei.useGas(new ethereumjs_util_1.BN(runState._common.param('gasPrices', 'callNewAccount')));
                }
            }
